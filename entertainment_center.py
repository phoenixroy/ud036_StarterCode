...
bhaag_milkha_bhaag = media.Movie(
    "Bhaag Milkha Bhaag",
    """The truth behind the ascension of Milkha 'The Flying Sikh' Singh who
    was scarred because of the India-Pakistan partition.""",
    "https://upload.wikimedia.org/wikipedia/en/4/42/Bhaag_Milkha_Bhaag_poster.jpg",  # NOQA
...
dangal = media.Movie(
    ...
    struggle towards glory at the Commonwealth Games in the face of societal
    oppression.""",
...
pink = media.Movie(
    ...
    "https://upload.wikimedia.org/wikipedia/en/a/ae/Pinkmovieposter.jpg",  # NOQA
...
chak_de_india = media.Movie(
    "Chak De! India",
    """Kabir Khan is the coach of the Indian Women's National Hockey Team
    and his dream is to make his all girls team emerge victorious
    against all odds.""",
...
zindagi_na_milegi_dobara = media.Movie(
    "Zindagi Na Milegi Dobara",
    """Three friends decide to turn their fantasy vacation into reality
    after one of their number becomes engaged.""",
    "https://upload.wikimedia.org/wikipedia/en/3/3d/Zindaginamilegidobara.jpg",  # NOQA
